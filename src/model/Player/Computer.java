...
public class Computer extends Player {
	...
	/**
	 * Constructeur principal de Computer
	 * @param nom Nom de l'ordinateur
	 * @param g Grille de l'ordinateur
	 * @param difficulty Difficulté de l'ordinateur
	 */
	...
	/**
	 * Choisi une case a cibler selon la difficulté de l'ordinateur
